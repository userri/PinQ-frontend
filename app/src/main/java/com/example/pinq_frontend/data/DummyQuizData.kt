...
object DummyQuizData {
    ...
    val todayQuizzes: List<Quiz> = listOf(
        Quiz(
            ...
            options = listOf(
                QuizOption(1L, "금융통화위원회"),
                QuizOption(2L, "한국통화정책회의"),
                QuizOption(3L, "기획재정부 금리위원회"),
                QuizOption(4L, "한국금융감독원"),
            ),
            correctOptionId = 1L,
        ...
        Quiz(
            ...
            options = listOf(
                QuizOption(1L, "원화 가치가 하락했다"),
                QuizOption(2L, "원화 가치가 상승했다"),
                QuizOption(3L, "원화 가치는 변화 없다"),
                QuizOption(4L, "달러 가치도 함께 상승했다"),
            ),
            correctOptionId = 2L,
            explanation = "AI 해설이 여기 들어갑니다. (Phase 2 에서 실제 해설로 대체)",
            relatedArticle = RelatedArticle(
        ...
        Quiz(
            ...
            options = listOf(
                QuizOption(1L, "코스피 상장 종목 모두가 2% 올랐다"),
                QuizOption(2L, "거래량이 2% 증가했다"),
                QuizOption(3L, "코스피 지수의 가중평균이 2% 올랐다"),
                QuizOption(4L, "외국인 매수세가 2% 늘었다"),
            ),
            correctOptionId = 3L,
            explanation = "AI 해설이 여기 들어갑니다. (Phase 2 에서 실제 해설로 대체)",
            relatedArticle = RelatedArticle(
        ...
        Quiz(
            ...
            options = listOf(
                QuizOption(1L, "주택 가격 대비 대출 한도 비율"),
                QuizOption(2L, "연소득 대비 대출 한도 비율"),
                QuizOption(3L, "보증금 대비 월세 비율"),
                QuizOption(4L, "주택 면적 대비 대출 금액"),
            ),
            correctOptionId = 1L,
            explanation = "AI 해설이 여기 들어갑니다. (Phase 2 에서 실제 해설로 대체)",
            relatedArticle = RelatedArticle(
