...
// 최저 단계는 "아주 조금 했다"이지 "안 했다"가 아니다. 예전 Grass1(#124A2E)은
// 밤 배경에서 빈 칸과 구별이 거의 안 돼, 1개 맞힌 날이 안 푼 날처럼 보였다.
// 빈 칸을 더 어둡게 내리고 1단계를 올려 둘 사이를 벌린다.
/** 활동 없음. */
val GrassEmpty = Color(0xFF122C48)
/** 1단계 — 짙은 초록 (0~1개 정답). */
val Grass1 = Color(0xFF1A6338)
/** 2단계 — 초록 (2개 정답). */
val Grass2 = Color(0xFF25914E)
/** 3단계 — 밝은 초록 (3개 정답). */
